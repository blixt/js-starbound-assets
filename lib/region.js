...
Region.prototype.getBackground = function (x, y) {
...
Region.prototype.getForeground = function (x, y) {
  var offset = this.getTileOffset(x, y);
  return [
    // Material id
